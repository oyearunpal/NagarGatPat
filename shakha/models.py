...
class Swaymsevak(models.Model):
    ...
    """
    fname = models.CharField("first name", max_length=20, blank=True, null=True)
    mname = models.CharField("middle name", max_length=20, blank=True, null=True)
    lname = models.CharField("Last name", max_length=20, blank=True, null=True)
...
class Spersonal(models.Model):
    ...
    basti = models.CharField(max_length=2, choices=Basti_Choice, default=1)
